class Solution:
    ...
    def carFleet(self, target: int, position: List[int], speed: List[int]) -> int:
        ...
        #note generally all available solutions take a different approach of processing right to left i.e sorting not in
        #increasing order of position but in decreasing order, honestly not needed if you maintain monotonic order
