class Solution:
    def pacificAtlantic(self, heights: List[List[int]]) -> List[List[int]]:
        ...
        #Cell marked as both pacific and atlantic will be our solution provided
            #In DFS from pacific, we consider flow only to lower than or equal to cells in height
            #In DFS from atlantic, we consider flow only to higher then or equal to cells in height
            #because gradients need to be in direction to pacific or atlantic
